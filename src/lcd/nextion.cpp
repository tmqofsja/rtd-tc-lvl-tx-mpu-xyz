...
void lcdSettemp3(float val) {
  myNex.writeNum("sk.float3.val", val);
}

void lcdSettemp4(float val) {
  myNex.writeNum("sk.float4.val", val);
}

void lcdSettemp5(float val) {
  myNex.writeNum("sk.float5.val", val);
}

void lcdSettemp6(float val) {
  myNex.writeNum("sk.float6.val", val);
}

void lcdSettemp7(String val) {
  myNex.writeStr("sk.string1.txt", val);
}

void lcdSettemp8(String val) {
  myNex.writeStr("sk.string2.txt", val);
}

void lcdSettemp9(String val) {
  myNex.writeStr("sk.string3.txt", val);
}

void lcdSettemp10(String val) {
  myNex.writeStr("sk.string4.txt", val);
}

void lcdSettemp11(String val) {
  myNex.writeStr("sk.string5.txt", val);
}

void lcdSettemp12(String val) {
  myNex.writeStr("sk.string6.txt", val);
}
void trigger1(void) { ; }
void trigger2(void) { ; }
void trigger3(void) { ; }
